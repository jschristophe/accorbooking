namespace AccorBooking.Entity
{
    ...
    public partial class AccorBookingContext : DbContext
    {
        //public static AccorBookingContext Context
        //{
        //    get
        //    {
        //        var optionsBuilder = new DbContextOptionsBuilder<AccorBookingContext>();
        ...
        //        optionsBuilder.UseSqlServer(ConfigurationManager.ConnectionStrings["AccorCatalogConnectionString"].ConnectionString);

        //        var result = new AccorBookingContext(optionsBuilder.Options);
        ...
        {
            optionsBuilder.UseSqlServer("data source=tcp:applinedbserver.database.windows.net,1433;initial catalog=CartDB;persist security info=True;user id=jschristophe;password='IrhcIrhc01;;';multipleactiveresultsets=True;application name=EntityFramework");
